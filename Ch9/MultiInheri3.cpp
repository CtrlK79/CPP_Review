...
public:
    ...
    void MiddleFuncOne() {SimpleFunc(); cout<<"MiddleDerivedOne"<<endl;}
};
...
public:
    ...
    void MiddleFuncTwo() {SimpleFunc(); cout<<"MiddleDerivedTwo"<<endl;}
};
...
public:
    ...
    void ComplexFunc() {MiddleDerivedOne();MiddleDerivedTwo();SimpleFunc();}
};
